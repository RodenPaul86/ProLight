...
class UILabelX: UILabel {
    ...
    */
    func centre(text str: String, context: CGContext, radius r:CGFloat, angle theta: CGFloat, slantAngle: CGFloat) {
        ...
        let attributes: [NSAttributedString.Key: Any] = [.foregroundColor: self.textColor as Any,
    ...
    func getRadiusForLabel() -> CGFloat {
        ...
        let heightOfFont = self.text?.size(withAttributes: [.font: self.font as Any]).height ?? 0
