...
struct alarmView: View {
    ...
    var body: some View {
        ...
        VStack {
            ...
            .padding()
            .background(.gray.opacity(0.06),in: RoundedRectangle(cornerRadius: 15))
            .padding(.top, 35)
                ...
                ZStack {
                    ...
                    ZStack {
                        ForEach(1...60,id: \.self) { index in
                            ...
                            // Each hour will have biger lines
                            // 60/5 = 12
                            // 12 Hours
                    ...
                    Image(systemName: "alarm.fill")
                        .foregroundColor(.blue)
                        .frame(width: 30, height: 30)
                    // Rotation Image Inside the Circle
                        .rotationEffect(.init(degrees: 90))
    ...
    func onDrag(value: DragGesture.Value, fromSlider: Bool = false) {
        //MARK: Converting Translation inti Angle
